	...
	<header class="fixed-top">
		...
		<div class="bottom-area">
			...
			<ul class="main-menu visible-on-click" id="main-menu">
				...
				<li class="drop-down"><a href="#">KATEGORI<i class="ion-ios-arrow-down"></i></a>
					<ul class="drop-down-menu">
						<li><a href="buku.php">Buku</a></li>
						<li><a href="buku.php">Komik</a></li>
						<li><a href="buku.php">Novel</a></li>
						<li><a href="buku.php">Majalah</a></li>
						<li><a href="buku.php">Majalah Anak</a></li>
						<li><a href="dm_kategori.php">Tambahkan Kategori</li>
				...
				<div class="col-lg-8 col-md-12">
					<div class="blog-posts">
						...
						<div class="single-post">
							<div class="image-wrapper"><img src="images/hauto.jpeg" alt="Blog Image" width="200px"></div>

							<div class="icons">
								<div class="left-area">
									<a class="btn caegory-btn">Komik</a>
								</div>
								<h3 class="title">Miiko</h3>
								<p>
							...
							<div class="single-post">
								<div class="image-wrapper"><img src="images/Melangkah.jpg" alt="Blog Image" width="200px"></div>

								<div class="icons">
									<div class="left-area">
										<a class="btn caegory-btn">Novel</a>
									</div>
									<h3 class="title">Melangkah</h3>
									<p>
										Empat orang yang berteman sejak SMA bekerja di perusahaan yang sama meski beda nasib. Di usia 31 tahun, mereka berburu rumah idaman yang minimal nyerempet Jakarta. Kaluna, pegawai Bagian Umum, yang gajinya tak pernah menyentuh dua digit. Gadis ini kerja sampingan sebagai model bibir, bermimpi membeli rumah demi keluar dari situasi tiga kepala keluarga yang bertumpuk di bawah satu atap. Di tengah perjuangannya menabung, Kaluna dirongrong oleh kekasihnya untuk pesta pernikahan mewah.
