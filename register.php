	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/Logo Prov Jawa Timur.jpeg');">
			<form action="registersql.php" method="POST">
				<form action="ceklogin.php" method="POST" class="form-horizontal" role="form">
					<div class="wrap-login100">
						<form class="login100-form validate-form">
							...
							<div class="container-login100-form-btn">
								<button type="submit" name="simpan" id="simpan" class="login100-form-btn">SIMPAN</button>
								<button type="reset" name="batal" id="batal" class="login100-form-btn">BATAL</button>
							</div>
