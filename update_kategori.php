...
$data = mysqli_query($mysqli, "SELECT * FROM tabel_kategori WHERE id_kategori ='$_GET[id]'");
		...
		<div class="wrap-contact100">
			<div class="contact100-form-title" style="background-image: url(images/12.jpg);">
				...
				<span class="contact100-form-title-2">
					<form method="POST" enctype="multipart/form-data" action="update_kategorisql.php">
						Masukkan Kategori
				</span>
			</div>
			...
			<form class="contact100-form validate-form">
				...
				<button type="submit" name="update" id_kategori="update" value="update" class="btn btn-primary btn-lg btn-block">Update</button>
				<button type="reset" name="reset" id_kategori="reset" value="Batal" class="btn btn-secondary btn-lg btn-block">Reset</button>
